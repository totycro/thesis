...
\newcommand{\content}{
	...
	We furthermore present strenghtenings of the theorem\nolinebreak{} (\ref{sec:strenghtenings}) as well as an application of it in the form of Beth's definabilty theorem (\ref{sec:beth}) and then continue to define the calculi, which will be used throughout this thesis (\ref{sec:resolution} and \ref{sec:lk}) including considerations on the applicabilty of interpolation to them (\ref{sec:resolution_and_interpolation}). 
