...
\chapter{Overbinding in one step}
\input{chapters/single_step_overbinding_attempt}
}
...
\chapter{The Resolution Calculus}
\input{chapters/resolution.tex}

\chapter{Proof by Reduction}
