...
\def\proofSkipAmount{ \vskip -0.1em } % NOTE: proofSkipAmount is by default something positive, i.e. having a skip of 0 here makes it less already
...
% this is slightly smaller than the default
