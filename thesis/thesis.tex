...
\newcommand{\content}{
	...
	We furthermore present strengthenings of the theorem\nolinebreak{} (\ref{sec:strengthenings}) as well as an application in the form of Beth's definability theorem (\ref{sec:beth}) and then continue to define the calculi, which will be used throughout this thesis (\ref{sec:resolution} and \ref{sec:lk}) including considerations on the applicability of interpolation to them (\ref{sec:resolution_and_interpolation}). 
