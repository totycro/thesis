...
\newcommand{\thmqed}{$\triangle$} % for thms without proof
\newcommand{\propqed}{$\triangle$} % for props without proof
\declaretheorem[title=Theorem,parent=chapter]{thm}
\declaretheorem[title=Proposition,parent=chapter]{prop}
\declaretheorem[title=Definition,style=definition,qed=$\triangle$,parent=chapter]{defi}
\declaretheorem[title=Example,style=definition,qed=$\triangle$,parent=chapter]{exa}
