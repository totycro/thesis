		...
		\item[Paramodulation.]
			...
			\begin{enumerate}
				\item $r$ occurs in a maximal $\Delta$-term $h\occur{r}$ in $D\occur{r}$ and $h\occur{r}$ occurs more than once in $D\occur{r} \lor \PI(D\occur{r})$.
					Then $\primexHuang r$ occurs in a maximal $\Gamma$-term $\primexHuang h\occur{r}$ in $\primexHuang D\occur{r}$ and $\primexHuang h\occur{r}$ occurs more than once in $\primexHuang D\occur{r} \lor \PI(\primexHuang D\occur{r})$.
					\begin{align*}
						\PI(C) &= [ ( s=t \land \PI(C_2) ) \lor (s\neq t \land \PI(C_1)) ]\sigma \lor (s=t \land h\occur{s} \neq h\occur{t})\sigma\\
