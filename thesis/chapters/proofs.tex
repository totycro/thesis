...
\begin{defi}[Lifting]
	...
	$\phi$ a formula or a term, $\colterm{1}, \dotsc, \colterm{n}$ the maximal $\Phi$-terms for $\Phi \in \{\Gamma, \Delta\}$ in $\phi$ and $x_1, \ldots, x_n$ fresh variables, referred to as \defiemph{lifting variables}.
	Then $\lft{\Phi}{x}{\phi}$ denotes $\phi\abstraction{\colterm{1}/x_1}\dots\abstraction{\colterm{n}/x_n}$.
