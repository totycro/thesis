...
\begin{defi}[Lifting]
	...
	$\phi$ a formula or a term, $Z=\{\colterm{1}, \dotsc, \colterm{n}\}$ the maximal $\Phi$-terms for $\Phi \in \{\Gamma, \Delta\}$ in $\phi$ and $z_1, \ldots, z_n$ fresh variables, referred to as \defiemph{lifting variables}.

	Then $\lft{\Phi}{z}{\phi}$ denotes % $\phi\abstractionOp{\colterm{1}/z_1}\dots\abstractionOp{\colterm{n}/z_n}$.
