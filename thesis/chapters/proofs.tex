...
\begin{defi}[Lifting]
	...
	$\phi$ a formula or a term, $\colterm{1}, \dotsc, \colterm{n}$ the maximal $\Phi$-terms for $\Phi \in \{\Gamma, \Delta\}$ in $\phi$ and $z_1, \ldots, z_n$ fresh variables, referred to as \defiemph{lifting variables}.
