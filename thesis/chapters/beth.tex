...
\begin{proof}
	...
	By interpreting the free variables as contants for the purposes of the application of the interpolation theorem, we can also ensure that the only free variables in $\chi$ are $y_1, \dots, y_n$. 
