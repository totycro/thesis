...
An abstraction on the other hand is a mapping of terms to variables. It is denoted by $\phi\termsubst{t/x}$, where $\phi$ is a formula or term where each occurrence of the term $t$ is replaced by the variable $x$.

TODO: define $A\occur{s}$ (and $A\occur{t}$)
