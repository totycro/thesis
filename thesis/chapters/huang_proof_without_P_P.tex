...
\begin{lemma}
	...
	Let $t_1, \dots, t_n$ be an arrangement of $\{ s_1, \dots, s_m, r_1, \dots r_k\}$ in ascending subterm order.
	Then
	\begin{itemize}
		\item
	...
	\end{itemize}
	where $Q_i$ is $\forall$ $(\exists)$ if ${t_i}$ is a $\Delta$ $(\Gamma)$-term.
\end{lemma}
\begin{proof}
	Let $Z^0 = \emptyset$ and $Z^i = \{ \lifdelta{r_1}, \dots, \lifdelta{r_i} \}$ for $1\varleq i \varleq k$.
