		...
		\indproofitem{Resolution}
			...
			\begin{enumerate}
				...
				\item Suppose that $l$ is $\Delta$-colored.
					...
					$\Gamma \entails \lifdelta{I_1\sigma} \lor \lifdelta{I_2\sigma} \lor (\lifdelta{D_\Gamma\sigma} \land \lifdelta{E_\Gamma\sigma})$.
				...
				\item Suppose that $l$ is grey.
					...
					$\Gamma \entails
					\lifdelta{I_1\sigma} \spam\lor
					\lifdelta{I_2\sigma} \spam\lor\allowbreak
					(\lifdelta{l_\Gamma\sigma} \land \lifdelta{E_\Gamma\sigma}) \spam\lor\allowbreak
					(\lnot\lifdelta{l'_\Gamma\sigma} \land \lifdelta{D_\Gamma\sigma})$.
