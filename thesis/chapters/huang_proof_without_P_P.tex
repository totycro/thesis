...
\begin{lemma}
	...
	\mytodo{ICI: formulate appropraitely, make sure it goes through: check what the $I$'s have to fulfill (should be obvious from proof)}

	\mytodo{make sure induction goes through with $\PI$ then}
\end{lemma}
