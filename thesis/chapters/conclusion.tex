...
The algorithmic approaches of Craig and Huang differ in their practical applicability. 
...
With our method, the scope of quantifiers is reduced by construction which leads to non-prenex interpolants.\todo{nothing new}
...
%S it works by constructing a model, equality does not require 
