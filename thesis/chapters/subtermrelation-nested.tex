...
\begin{exa}
	...
	\begin{prooftree}
		...
		\BinaryInfCm{ S(\var{8}) \mid  P(f(\var{2}, g(a, \var{4}))) \land R(f(\var{1}, \var{6})) \spam \lor \lnot P(f(\var{2}, g(a, \var{4}))) \land \exists y_b Q(g(a, y_b))  }
		\noLine
		\UnaryInfCm{ S(\var{8}) \mid \forall x_a \exists y_{f(\var{2}, g(a, \var{4}))} \big(  P(y_{f(\var{2}, g(a, \var{4}))}) \land R(f(\var{1}, \var{6})) \spam \lor \lnot P(y_{f(\var{2}, g(a, \var{4}))}) \land \exists y_b Q(g(x_a, y_b)) \big) }

		\AxiomCm{\lnot S(b) \mid \top}
		\RightLabelm{\resrule{\resruleres}{\var{8} \mapsto b}}

		\BinaryInfCm{ \square \mid S(b) \land  \forall x_a \exists y_{f(\var{2}, g(a, \var{4}))} \big(  P(y_{f(\var{2}, g(a, \var{4}))}) \land R(f(\var{1}, \var{6})) \spam \lor \lnot P(y_{f(\var{2}, g(a, \var{4}))}) \land \exists y_b Q(g(x_a, y_b)) \big) }
		\UnaryInfCm{ \square \mid \exists y_b \big( S(y_b) \land  \forall x_a \exists y_{f(\var{2}, g(a, \var{4}))} \big(  P(y_{f(\var{2}, g(a, \var{4}))}) \land R(f(\var{1}, \var{6})) \spam \lor \lnot P(y_{f(\var{2}, g(a, \var{4}))}) \land \exists y_b Q(g(x_a, y_b)) \big) \big) }
