...
\begin{thm}
	...
	$t_1, \dots, t_n$ be the maximal colored terms in $\PI(\pi)$ in ascending order by their length.
	Then
...
\begin{proof}
	...
	Note that as $t_1, \dots, t_n$ are ordered by length, they are also in subterm order as subterms are strictly smaller than the term they are part of.
