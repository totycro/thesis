...
\parti{\Gamma_1}{\Delta_1}{\Gamma_2, A, A}{\Delta_2}, which again is also an interpolant for $\partisym$.
	...
	\item The last rule application was an instance of implication left. Then it is of the form:
					\begin{prooftree}
						\Axiomm{\Gamma \fCenter \Delta,  A}
					...
					\begin{enumerate}
						\item $\chi = \parti{\Gamma_1, \Sigma_1, A\limpl B}{\Delta_1, \Pi_1}{\Gamma_2, \Sigma_2}{\Delta_2, \Pi_2}$.
							...
							Using these prerequisites, we show that $I_1 \lor I_2$ is an interpolant for $\chi$:
							\medskip
