...
\begin{defi}[Partition of sequents]
	A \defiemph{partition} of a sequent $\Gamma \proves \Delta$ is denoted by $\parti{\Gamma_1}{\Delta_1}{\Gamma_2}{\Delta_2}$, where $\Phi_1 \cap \Phi_2 = \emptyset$ and $\Phi_1 \cup \Phi_2 = \Phi$ for $\Phi \in \{\Gamma, \Delta\}$.
\end{defi}
...
\begin{proof}
	...
	\begin{description}
		...
		\item[\normalfont Structural rules.]
			...
			\begin{itemize}
				\item The last rule application was an instance of \lkrule{c}{l}. Then it is of the form:
					\begin{prooftree}
...
\parti{\Gamma_1}{\Delta_1}{\Gamma_2, A, A}{\Delta_2}, which again is also an interpolant for $\partisym$.
				...
				\item The last rule application was an instance of \lkrule{w}{r}. Then it is of the form:
					\begin{prooftree}
		...
		\item[\normalfont Propositional rules.]
			...
			\begin{itemize}
				\item The last rule application was an instance of \lkrule{\lnot}{l}. Then it is of the form:
					\begin{prooftree}
				...
				\item The last rule application was an instance of \lkrule{\limpl}{l}. Then it is of the form:
					\begin{prooftree}
						\Axiomm{\Gamma \fCenter \Delta,  A}
					...
					There are two possible partitions of $\Gamma, A\limpl B \vdash \Delta$:
					\begin{enumerate}
						\item $\partisym = \parti{\Gamma_1, \Sigma_1, A\limpl B}{\Delta_1, \Pi_1}{\Gamma_2, \Sigma_2}{\Delta_2, \Pi_2}$.
							...
							Hence for $I_1$, it holds that $\Gamma_1 \fCenter \Delta_1, A, I_1$ and 
							$I_1, \Gamma_2 \fCenter \Delta_2$.
							...
							This implies that $\Sigma_1, B \fCenter \Pi_1, I_2$ and $I_2, \Sigma_2 \fCenter \Pi_2$.

							Using these prerequisites, we show that $I_1 \lor I_2$ is an interpolant for $\partisym$:
							\medskip
...
\begin{proof}
	...
	By Lemma \ref{lemma:maehara}, there is an interpolant $I$ for the partition \parti{C}{}{}{D}. $I$ is also an interpolant of $\Gamma$~and~$\Delta$.
