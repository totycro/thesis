...
\begin{lemma}
	Let $t$ be a term and $\sigma$ a substitution
	Then
	$\lifdelta{\lifdelta{t} \sigma} = \lifdelta{t\sigma}$.
	\comm{true and used}
\end{lemma}
\begin{proof}
	...
	$\lifdelta{t\sigma} = \lifdelta{t}\sigma'$

	$\lifdelta{\lifdelta{t}\sigma} = \lifdelta{\lifdelta{t}}\sigma' = \lifdelta{t}\sigma' $
