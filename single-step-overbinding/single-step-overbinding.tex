...
\begin{proof}
	...
	\NB{possibly try to show that $u\sigma = t_k$ in first item}
	...
	\begin{itemize}
			\item
				...
				%As $(x_j\mapsto x_k)\in \tau$, the underlying terms are unified. %, which is the same as $t_j\rho' \sigma = t_k \sigma$. 
