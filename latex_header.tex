...
% for \ContinuedFloat % this can cause problems with memoir
...
\newcommand{\LIpre}{\LI^\bullet}

\newcommand{\PIstep}{\PI_{\mathrm{step}}}
\newcommand{\PIinit}{\PI_{\mathrm{init}}}

%\newcommand{\nosigmasym}{\circ}
%\newcommand{\nosigma}{^\nosigmasym}

%$\newcommand{\Wtilde}[1]{\stackrel{\sim}{\smash{#1}\rule{0pt}{1.1ex}}}
%\newcommand{\Wtilde}[1]{\stackrel{\sim}{#1}}
\newcommand{\Wtilde}[1]{\bm\tilde{#1}}


\newcommand{\nosigma}[1]{\Wtilde{#1}}
\newcommand{\PInosigma}{\Wtilde{\PI}}

%\newcommand{\PIstepnosigma}{\PInosigma_{\mathrm{step}}}
\newcommand{\PIstepstarnosigma}{\PInosigma^{*}_{\mathrm{step}}}

%\newcommand{\PIstarnosigma}{\bm\tilde\PI^{*\nosigmasym}}
\newcommand{\PIstarnosigma}{\PInosigma^{*}}
...
\newcommand{\domainofmodel}[1]{\ensuremath{D_{#1}}}
\newcommand{\interpretation}[1]{\ensuremath{\calI_{#1}}}
...
\DeclareMathOperator{\defeq}{\,\stackrel{\mathclap{\mathrm{def}}}{=}\,}
\DeclareMathOperator{\defeqBeamer}{\,\stackrel{\mathclap{\mathsf{def}}}{=}\,}
...
\newcommand{\lifpart}{\lifsym_\mathrm{part}}
...
\newcommand{\lifgammadelta}[1]{\lift{\Gamma\cup\Delta}{#1}{z}}

\newcommand{\tauell}{\tau^\lifsym}
\newcommand{\tauellphi}{\tau^{\lifsym_\Phi}}
\newcommand{\tauelldelta}{\tau^{\lifsym_\Delta}}
...
\newcommand{\quantifierdots}{\dots} % dots for $\forall x_1 \quantifierdots \forall x_n$
% cdots are somewhat nicer, but look inconsistent with other dots at the bottom of the line 
%\newcommand{\quantifierdots}{\cdots} % dots for $\forall x_1 \quantifierdots \forall x_n$
...
%\tolerance=9999 %  really much tolerance, 10k is max
%\emergencystretch=\maxdimen % this creates really ugly lines
...
\newcommand{\sigmazmi}[0]{\sigmaz{i-1} }
...
\newcommand{\resrule}[2]{\ensuremath{\underset{#2}{{#1}}}} 
\newcommand{\resruleremark}[3]{\ensuremath{\underset{#2}{{#1}} #3}}
%\newcommand{\lkrule}[2]{\ensuremath{\stackrel{\operatorname{#1}}{#2}}} % operatorname fixes spacing issues for =
...
\newcommand{\occuratp}[1]{\occurat{#1}{p}}
...
\newcommand{\definethms}{
	...
	\newcommand{\lemmaqed}{$\blacksquare$} % for lemmas without proof
	...
	\declaretheorem[sibling=thm,title=Refutated Lemma {\color{red} {(this is wrong)}}]{rlemma}
...
\DeclareMathOperator{\ca}{col-alt}
\DeclareMathOperator{\qa}{quant-alt}

\usepackage{cases} % numcases


% this should be loaded last: http://tex.stackexchange.com/questions/86343/no-room-for-a-new-mathgroup
\usepackage{bm} % bm, bold math symbols


\newcommand{\allbold}[1]{\textbf{\boldmath{#1}}}

\usepackage{pdflscape} % like lscape but rotates pdf-page automatically

\newenvironment{indproof}{ \begin{itemize} }{ \end{itemize} } \newcommand{\indproofitem}[1]{\item[#1.]}
%\newenvironment{indproof}{ \begin{description} }{ \end{description} } \newcommand{\indproofitem}[1]{\item{}#1.}
