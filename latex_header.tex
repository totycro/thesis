...
\newcommand{\AImatrix}{\ensuremath{\AI_\text{matrix}}}
...
\newcommand{\subst}[1]{[#1]}
\newcommand{\abstraction}[1]{\{#1\}}

%\newcommand{\lift}[3]{\operatorname{Lift}_{#1}(#2; #3)}
%\newcommand{\lift}[3]{\operatorname{Lift}_{#1,#3}(#2)}
%\newcommand{\lift}[3]{\operatorname{Lift}_{#1,#3}[#2]}
%\newcommand{\lift}[3]{\overline{#2}_{#1,#3}}
\newcommand{\lift}[3]{\ell_{#1,#3}[#2]}

\newcommand{\arr}[1]{\ensuremath{\mathcal{A}(#1)}}
\newcommand{\warr}[1]{\ensuremath{\mathcal{W}(#1)}}

\newcommand{\pos}[1]{\ensuremath{p(#1)}}
...
\newcommand{\lkrule}[2]{\ensuremath{#1:#2}}
