...
\begin{enumerate}
	...
	\item 
		...
		In the graph-theoretic view, this should mean that if terms $t$ and $t'$ are from $l$ and $l'$ respectively and unified, then their components are to be merged. \mytodo{formalise this}.
