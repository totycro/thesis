...
\begin{changebar}
	...
	\begin{proof}
		...
		Then by the definition of $\aiu$, the $z_k$ refers to $\colterm{k}$. 

		Furthermore, by the induction hypothesis, $A = \colterm{j}\rho$.
		But also by the definition of $\aiu$, $a\sigma = \colterm{k}$.
