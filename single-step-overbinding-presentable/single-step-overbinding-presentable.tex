...
\begin{enumerate}
	...
	\item 
		...
		Variable renamings:\todo{necessary special case}{} For $\marr(C)$, we also add $\{p_1, p_2\}$
		for
		...
		Backwards merging case 1:\todo{necessary special case}{} if for variable $x,y,z$
		and the unifier $\sigma$ of the resolution step we have that $x$ occurs grey in $z\sigma$ and $x$ occurs colored in $y\sigma$, then add an arrow from every grey occurrence of $z$ to every grey occurrence of $y$.

		Backwards merging case 2:\todo{necessary special case}{} 
		same as 1, but also add arrows from every grey occurrence of $z$ to every $\Gamma$-colored occurrence of $y$ (which is not visible after lifting, but is visible in $\AIde$).

		Backwards merging case 3:\todo{necessary special case}{} 
		If $x$ occurs in $y\sigma$, then add an arrow from every grey occurrence of $x$ in $C$ to every grey occurrence of $y$.

		special case 210g':\todo{necessary special case}{}
