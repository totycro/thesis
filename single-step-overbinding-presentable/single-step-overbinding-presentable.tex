...
\begin{enumerate}
	...
	\paragraph{Special cases.}
		...
		\hl{feasible} \NB{only for merge arrows between grey vars, possibly not needed} Backwards merge case 4:\todo{necessary special case}{} 
		...
		\mytodo{are there double arrows for lifting variables containing variables? yes, think so }
