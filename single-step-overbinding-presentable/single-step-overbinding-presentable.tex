...
\begin{lemma}
	...
	A resolution derivation can only contain multicolored $\Gamma$-term if there is a variable which has a $\Gamma$-colored occurrence and a grey occurrence in a clause.
\end{lemma}
\begin{proof}
...
\begin{conj}
	Let $C$ be a clause which contains a multicolored $\Gamma$-term.
\end{conj}
