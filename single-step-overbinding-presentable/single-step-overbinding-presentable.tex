...
\begin{enumerate}
	...
	\item 
		...
		If $y$ occurs in $x\sigma$, add an arrow from every grey occurrence of $y$ in $C_i$ to every colored occurrence of $x$ in $C$.
		The colored occurrences of $x$ can be deduced by subtracting the grey occurrences from the connected components of $x$-occurrences (Lemma~\ref{prop:colored_variables_connected}). 
