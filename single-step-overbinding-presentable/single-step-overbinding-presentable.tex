...
\begin{enumerate}
	...
	\item 
		...
		\hl{feasible} Unifier arrow 1:\todo{necessary special case}{} 
		If $y$ occurs in $x\sigma$, add an arrow from every grey occurrence of $y$ to every colored occurrence of $x$.
		...
		\hl{feasible} Unifier arrow 2:\todo{necessary special case}{} 
		If a lifting variable $z_i$ occurs in $x\sigma$, add an arrow from every grey occurrence of $z_i$ to every colored occurrence of $x$.
