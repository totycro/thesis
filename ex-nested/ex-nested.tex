...
\largered{possibly important intermediate step before last formula:

	$
	P(f(x_a), x_a) \lor \forall x_a( Q(x_a) \lor R(x_a)) 
	$
...
\largered{TODO figure out why this always works}
\largered{possibly write down logical justification of steps down very precisely as for paramod special case}
