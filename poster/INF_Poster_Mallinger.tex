		...
		%		 \\
			...
			\itemizeOnBlockStart
				\begin{itemize}
					...
					\item We showed that the number of \emph{quantifier alternations} in the extracted interpolant essentially corresponds to the number of \emph{color alternations} in the terms of the proof.
