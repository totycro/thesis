...
%\newcommand{\myA}{ \tikzset{letter left=TuInfRed,letter right=InfosysDarkGrey} \bicolorletter{A} }
\newcommand{\myA}{ \tikzset{letter left=InfosysDarkGrey,letter right=TuInfRed} \bicolorletter{A} }
%\newcommand{\myB}{ \tikzset{letter left=TuWienBlue,letter right=InfosysDarkGrey} \bicolorletter{B} }
	...
	\begin{columns}[t]
		...
		\begin{column}{\mycolwidth}
			...
			\begin{block}{Craig Interpolation}
				...
				\textbf{Theorem} (Craig).
				\emph{Let \myA{} and \myB{} be first-order formulas such that $\entails \myA\supset \myB$.
					Then there is an interpolant $\gray I$ for $\myA$ and~$\myB$ such that:
					\begin{itemize}
		...
		\begin{column}{\mycolwidth}
			...
			\begin{block}{Interpolant extraction from proofs in two phases \cite{Huang95}}
				...
				\begin{tabular}[x]{@{}l@{}}Propositional\\Interpolant:\end{tabular} 
					...
					\multicolumn{2}{l}{
						\hspace*{10.35em}{$\Downarrow$} ~\parbox[t]{11em}{\emph{ Replace colored function and constant symbols } }
						\vspace*{0.5em}
				}
				\\
				...
				\begin{tabular}[x]{@{}l@{}}Prenex\\First-Order\\Interpolant:\end{tabular} 
					&
					\multicolumn{1}{m{\fakemulticolwidth}}{
						\includegraphics[width=0.2\textwidth]{figures/two_phase_draft_fo_interpolant}
					}
