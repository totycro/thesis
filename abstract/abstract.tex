...
\declaretheorem[qed=$\dagger$,title=Theorem]{thm}
%\declaretheoremstyle[qed=\qedsymbol]{thmstyle}
%\declaretheorem[title=Theorem,style=thmstyle]{thm}
%\declaretheorem[title=Theorem,shaded]{thm}
...
%by means of abstraction, i.e.\ automatically derived predicates overapproximate them.
