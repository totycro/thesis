...
\begin{lemma}
	If $x$ occurs in a single-colored $\Delta$-term in $y\sigma$, then there is a sequence $y_1, \dots, y_n$ such that for each $y_i$, $y_i\sigma$ contains a grey occ of $x$ or single-colored $\Delta$-term containing $x$.
	Furtheremore, either

	(1) some single-colored $\Delta$-term containing $x$ occurs in $l$ or $l'$

	(2) some single-colored $\Gamma$-term containing $x$ occurs in $l$ or $l'$ and there is a color change: some $y_i$ is contained in a $\Delta$-term and some $y_{i+1}$ is contained in a $\Gamma$-term. (hence $y_i$ and $y_{i+1}$ have a grey occ of $x$).
