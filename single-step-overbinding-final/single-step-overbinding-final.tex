...
\begin{proof}
	...
	As the $\mgu$ algorithm produces a unifier which modifies $x_i$, $x_i$ must occur in a resolved or factorised literal, say in $l$ at $l\at{\bhat x_i}$, such that at the other resolved or factorised literal $l'$,  $l'\at{\bhat x_i}$ is an abstraction of a term containing $t$ which is different from $x_i$.
