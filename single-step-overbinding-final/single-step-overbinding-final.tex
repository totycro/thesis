...
\begin{lemma}
	...
	$x_i$ occurs in a resolved or factorised literal $l$ at $l\at{\bhat x_i}$ such that $l'\at{\bhat x_n}$ contains $x_{i+1}$ for $1\varleq i \varleq n-1$ and $l'\at{\bhat x_n}$ contains the outermost symbol of $t$, 
	where $l'$ is the other resolved or factorised literal.
\end{lemma}
\begin{proof}
