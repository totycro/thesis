...
\begin{lemma}
	...
	$i=n \land x_n \mguarr r_t$, where $r_t$ and $t$ agree on the outermost symbol.
	%$x_i$ occurs in one of the literals, say $l_i$, at $l_i\at{\bhat x_i}$ such that
	%with $l_i'$ being the respective other literal,
\end{lemma}
\begin{proof}
...
\begin{lemma}
	\label{lemma:single_col_x_in_unif_range}
	Let $l$ and $l'$ be variable-disjoint literals and $\sigma = \mgu(l, l')$
		...
		\item{}Resolution.
			...
			\begin{itemize}
				...
				\item Suppose that
					...
					\largered{ possible unify lemma 24 and 25, 25 seems to be stronger on the grey part which seems to be shared with 24 }
