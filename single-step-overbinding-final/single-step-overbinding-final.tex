...
\begin{defi}
	...
	\begin{itemize}
		...
		\item[Resolution.]
			...
			\largered{ really maximal $\Phi$-term ?}
...
\begin{defi}
	...
	Base case: $\Lambda(C) = C$

	Resolution: $\Lambda(C) = \{ \lifboth{ \varphi \sigma} \tau \mid \varphi \in \Lambda(C_1) \cup \Lambda(C_2) \}$

	Factorisation: $\Lambda(C) = \{ \lifboth{ \varphi \sigma} \tau \mid \varphi \in \Lambda(C_1) \}$ \comm{no merge atm as literals are equal anyway }
