...
\begin{proof}
	...
	\begin{description}
		...
		\item{}Resolution.
			...
			Hence $z$ occurs elsewhere in $\lambda'$, say in $\lambda'\at{\bhat z}$.
			If $\lambda'\at{\bhat z}$ is a grey occurrence or $\lambda'\at{\bhat z}$ is contained in a single-colored $\Delta$-term, 
			there is a corresponding occurrence of $x$ in g
