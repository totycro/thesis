...
\begin{clemma}[corresponds to lemma 25 in -final]
	Let $\sigma = \mgu(l, l')$.
...
\begin{proof}
	...
	So supp $\sigma_i = \{ y \mapsto \epsilonx \}$\todo{in a final version, perhaps not use $x$ here, because as explained, it doesn't need to be $x$}.
	...
	\mytodo{ICI ; looks done but recheck. do other lemmas as they are needed in the actual main arrow lemma}
