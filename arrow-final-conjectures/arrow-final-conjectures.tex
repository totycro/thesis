...
\begin{lemma}[corresponds to lemma 25 in -final]
	...
	Suppose a s.c.\ $\Phi$-term $s\occ{y}$ occs in $l \sigma_{0\ra i}$ or $l'\sigma_{0\mapsto i}$ where $0\varleq i \varleq n$ and $\sigma_0 = \id$ s.t.\ a var $x$ occurs grey in $y\sigma$.
	At least one of the following statments holds:

	\begin{enumerate}
			\item $x$ occurs grey in $l\sigma$
			\item var $z$ s.t.\ $x$ occs grey in $z\sigma$ OR the var x itself occur in s.c.\ $\Phi$-term in  
				$l\sigma_{0\ra i-1}$  
				%$x$ occurs in a s.c.\ $\Phi$-term in
			\item there is a col change where $x$ is the col change var in $l\sigma$
	\end{enumerate}
\end{lemma}
\begin{proof}
