...
\largered{there is an error: $g$ is treated as a $\Pi$-symbol but is $\Sigma$-colored}
...
\begin{prooftree}
	...
	\BinaryInfCm{ (\forall x_3) \exists y_2 \forall x_4 (\forall x_3) \Big((\lnot P(x_4) \land \lnot R(x_3)) \lor (P(x_3) \land \lnot S(y_2)) \Big)}
...
$\Gamma \entails (\lnot S(a) \land \top ) \lor (S(a) \land \bot) \lor \lnot P(x_4) \spa\equiv \lnot S(a)\lor \lnot P(x_4)$
 \line(1,0){250}
\newline
$\Gamma \entails (\lnot P(x_3) \land \lnot R(x_3)) \lor (P(x_3) \land \lnot S(a)) $
