...
\begin{prooftree}
	...
	\AxiomCm{ \top \mid - }
	\RightLabel{\stackanchor{$x_1 \mapsto f(a)$}{$x\mapsto a$}}
	\BinaryInfCm{ P(a, f(a)) \mid R(y) }

	\AxiomCm{ \bot \mid Q(x_2, g(x_2)) \lor \lnot R(u) }
	\AxiomCm{ \bot \mid \lnot S(a)}
	\AxiomCm{ \top \mid \lnot Q(f(z), x_3) \lor S(z)}
	\RightLabelm{z \mapsto a}
	\BinaryInfCm{ \lnot S(a) \mid \lnot Q(f(a), x_3) }
