...
\begin{prooftree}
	...
	\BinaryInfCm{ Q(x_2) \land P(f(x)) \mid R(x) \lor S(h(x_2))  }

	\BinaryInfCm{
	\big(Q(x_2) \land P(f(x_0))\big) \lor R(x_0) \mid S(h(x_2))  }

	\BinaryInfCm{ 
	\big(Q(x_2) \land P(f(x_0))\big) \lor R(x_0) \lor S(h(x_2))  }

\end{prooftree}


$ \forall x_0 \forall x_2 \forall x_5 \big(\lnot Q(x_2) \land P(f(x_0))\big) \lor R(x_0) \lor S(h(x_2))$ 
