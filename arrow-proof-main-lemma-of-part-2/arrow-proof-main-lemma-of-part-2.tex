...
\begin{proof}
	...
	\begin{description}
		\item[Suppose $y\sigma$ is a grey occurrence of $x$ and a colored $t\occ{y}$ occurs in $C_1$.]

			\begin{itemize}
				\item Suppose $l\at{\bhat y}$ is a grey occurrence.
				\item Suppose $l\at{\bhat y}$ is a colored occurrence.
			\end{itemize}

		\item[Suppose $y\sigma$ is a colored occurrence of $x$ and $y$ occurs in $C_1$.]
	\end{description}
\end{proof}
