...
\begin{lemma}
	...
	Let $x$ be a variable in $\AIclause\de(C)$ which has a grey occurrence $p$ and a colored occurrence $q$. 
	Then there is an arrow in $\arr(C)$ from a term containing $p$ to a term containing $q$.
