...
\begin{defi}[Incremental lifting]
	...
	\begin{itemize}
		...
		\item[Resolution.]
			...
			\todo[inline]{say something about $l\cll$ and/or rewrite that (also below)}
...
\begin{proof}
	...
	\begin{description}
		...
		\item{} Resolution.
			...
			Ind hyp gives $\Gamma \entails \PIincde(C_1)  \lor \lifidelta{D} \lor l\cllde $\todo{Don't really say $\lifidelta{D}$ here, we only have $\lifidelta{C}$}{}
			and similar for $C_2$.
